    ...
    return (
      <div>
        <div style="padding-bottom:10px; font-size: 24px;font-weight: bold;">
          {app.translator.trans("huoxin-money-with-history.forum.title")}
        </div>
        ...
        {!this.loading && this.historyEntries.length===0 && (
          <div>
            <div style="font-size:1.4em;color: var(--muted-more-color);text-align: center;height: 300px;line-height: 100px;">{app.translator.trans("huoxin-money-with-history.forum.list-empty")}</div>
          </div>
        )}
