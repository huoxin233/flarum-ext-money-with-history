...
class MigrationCompatibilityTest extends TestCase
{
    protected function tearDown(): void
    {
        ...
        // Recreate the table from legacy fixture so Flarum's migration tracker stays consistent
        $legacyCreate = require __DIR__.'/../fixtures/legacy_create_user_money_history_table.php';
    ...
    public function it_migrates_legacy_money_history_rows_to_the_current_schema_without_data_loss(): void
    {
        ...
        // Use the LEGACY schema fixture to simulate an old mattoid installation
        $createMigration = require __DIR__.'/../fixtures/legacy_create_user_money_history_table.php';
